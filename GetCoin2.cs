...
public class GetCoin2 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        GetCoinStatic.coin2 = int.Parse(TextCoin.text);
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            GetCoinStatic.coin2 += increaseCoin;
            TextCoin.text = GetCoinStatic.coin2.ToString();
            Destroy(gameObject);
            Debug.Log("coin =" + GetCoinStatic.coin2);
        }
    }
}
